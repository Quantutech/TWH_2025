...
import { socialLink, directoryFooterLink } from "@repo/ui/constants/constant";
        ...
        >
          ...
          >
            <SimpleGrid
              ...
              width="100%"
            >
              {directoryFooterLink.map((section) => (
          ...
          >
            <VStack maxW={"628px"} alignItems={"start"}>
              ...
              <Text fontSize={"16px"} fontWeight={"400"} lineHeight={"normal"}>
                ...
                mental health services, resources, and
                <br /> providers—empowering individuals to take control of their
